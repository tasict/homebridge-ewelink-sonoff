...
module.exports = {
   ...
   devicesUSB: [77],
   devicesBridge: [28],
   paramsToKeep: ["bright", "brightness", "channel", "colorB", "colorG", "colorR", "currentHumidity", "currentTemperature", "fan", "fwVersion", "light", "mainSwitch", "mode", "online", "rfList", "rfTrig", "sensorType", "speed", "state", "switch", "switches", "type", "zyx_mode"],
   chansFromUiid: {
