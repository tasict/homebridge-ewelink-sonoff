...
module.exports = {
   ...
   devicesUSB: [77],
   devicesBridge: [28],
   paramsToRemove: ["sledOnline", "configure", "pulses", "startup", "pulse", "pulseWidth", "rssi", "controlType", "power", "uiActive", "fwVersion", "staMac", "startup_light", "startup_fan", "voltage", "current", "alarmVValue", "alarmCValue", "alarmPValue", "oneKwh", "bindInfos", "init", "version", "lock", "partnerApikey", "timers"],
   chansFromUiid: {
      ...
      76: 0, // "YI_GE_ER_LAMP"
      77: 4, // "SINGLE_SOCKET_MULTIPLE" (1 switch device using data structure of four :()
      78: 4, // "SINGLE_SWITCH_MULTIPLE"
      ...
      109: 0, // "YK_INFRARED_2"
      1000: 0, // "ZIGBEE_WIRELESS_SWITCH"
      1001: 0, // "BLADELESS_FAN"
      1002: 0, // "NEW_HUMIDIFIER"
      1003: 0, // "WARM_AIR_BLOWER"
      1770: 0, // "ZIGBEE_TEMPERATURE_SENSOR"
      1256: 0, // "ZIGBEE_SINGLE_SWITCH"
      2026: 0, // "ZIGBEE_MOBILE_SENSOR"
      3026: 0, // "ZIGBEE_DOOR_AND_WINDOW_SENSOR"
      4026: 0, // "ZIGBEE_WATER_SENSOR"
