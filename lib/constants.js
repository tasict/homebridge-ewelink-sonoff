...
module.exports = {
   ...
   devicesUSB: [77],
   devicesBridge: [28],
   paramsToRemove: ["sledOnline", "configure", "pulses", "startup", "pulse", "pulseWidth", "rssi", "controlType", "power", "uiActive", "fwVersion", "staMac", "startup_light", "startup_fan", "voltage", "current", "alarmVValue", "alarmCValue", "alarmPValue", "oneKwh", "bindInfos", "init", "version", "lock", "partnerApikey"],
   chansFromUiid: {
